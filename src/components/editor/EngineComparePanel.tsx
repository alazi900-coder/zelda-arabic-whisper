...
import { Loader2, Check, Sparkles, Columns } from "lucide-react";
...
export default function EngineComparePanel({
  ...
  const handleApply = (result: EngineResult) => {
    if (!result.translation) return;
    onApplyTranslation(targetKey, result.translation);
    setApplied(result.engine);
    toast({ title: "✅ تم تطبيق الترجمة", description: `من محرك ${result.label}` });
  };
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  {!r.loading && r.translation && (
                    <Button
                      ...
                      size="sm"
                      className="mr-auto h-7 px-3 text-xs"
