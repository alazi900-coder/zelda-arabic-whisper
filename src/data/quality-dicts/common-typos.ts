...
export const COMMON_TYPOS_DICT: ReadonlyArray<readonly [wrong: string, right: string]> = [
  ...
  ["جزاكالله", "جزاك الله"],
  // Verbs / conjugations — أفعال المتكلّم بهمزة القطع (أ)
  ["اخذت", "أخذت"],
  ["اخذتها", "أخذتها"],
  ["اعطاني", "أعطاني"],
  ["اعطيتك", "أعطيتك"],
  ...
  ["الاعمال", "الأعمال"],
  ["الاحوال", "الأحوال"],
  // Common mistranslations / colloquialisms — أبقينا تصحيحات الهمزة فقط.
  // إضافة التنوين (شكراً، عفواً، لاحقاً، دائماً، تماماً، جداً، معاً،
  // تقريباً، نهائياً...) أسلوبيّة وتتسبّب بإيجابيّات خاطئة لأنّ كثيراً من
  // الكتّاب يتركونها عمداً. وكذلك «شكر وداع» أسماء صحيحة وليست دائماً مصدراً.
  ["اهلا", "أهلاً"],
  ["احيانا", "أحياناً"],
  ["ابدا", "أبداً"],
  ["مرة اخرى", "مرة أخرى"],
